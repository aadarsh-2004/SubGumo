...
export const Footer = () => {
  return (
      ...
      <footer className="bg-white mt-24 font-poppins text-white py-8">
        <div className="max-w-7xl text-black mx-auto mb-24 px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#about" className="text-gray-700 hover:text-white">
                    About Us
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#privacy" className="text-gray-700 hover:text-white">
                    Privacy Policy
                  </a>
                </li>
              </ul>
